...
export default function page() {
  ...
  const userNameSpan = useRef<HTMLInputElement>(null);
  const emailSpan = useRef<HTMLInputElement>(null);
  const passwordSpan = useRef<HTMLInputElement>(null);
    ...
    <>
      <div className={style.parent}>
        <div className={`${style.form_parent} ${isFormErrorEmail || isFormErrorPass || isFormErrorName ? style.form_parent_danger : ""}`}>
          ...
          <form>
            <div className={style.input_parent} ref={userNameInput}>
              <input
                type="text"
